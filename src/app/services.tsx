  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-16 md:gap-32 max-w-7xl">
        <div className="bg-primary w-full max-w-[200px] md:max-w-[500px] h-8"></div>
        <h1
          className={cn(
            layout.fonts.highlight.className,
            'text-2xl md:text-4xl font-bold uppercase -mt-16',
          )}
        >
          Qual sua história?
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-16 w-full ">
