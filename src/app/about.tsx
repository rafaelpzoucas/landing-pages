          ...
          {isExpanded ? (
            <>
              <p>
                ...
                posteriormente esta trajetória culminou na obtenção do meu
                diploma na área, consolidando minha vocação e paixão pelo
                exercício da advocacia.
              </p>
              <p>
                Especializado e dedicado exclusivamente ao Direito Penal,
                empenho-me para aprimorar minhas habilidades e conhecimentos
                nesta área específica.
              </p>
              <p>
                Além disso, tenho o privilégio de ser autor de diversos artigos
                jurídicos, abordando uma ampla gama de temas relevantes, os
                quais foram publicados em conceituados portais de notícias. Esta
                contribuição acadêmica reflete meu compromisso com a
                disseminação do conhecimento e a promoção de debates
                construtivos no meio jurídico.
              </p>
              <p>
                Minha atuação estende-se por todo o território nacional,
                proporcionando-me uma visão abrangente e multifacetada das
                questões jurídicas.
              </p>
              <p>
                Como profissional, sou guiado por princípios éticos inabaláveis,
                comprometido com a justiça e o respeito aos direitos
                fundamentais de meus clientes. Minha missão é garantir que a lei
                seja aplicada de forma justa e equitativa, sempre buscando a
                melhor defesa dos interesses daqueles que represento.
              </p>
